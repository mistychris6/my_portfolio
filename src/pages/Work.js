      ...
      <div>
        ...
        <h2>Skills</h2>
          <ul>
            ...
            <li>Linux</li>
            <li>Git</li>
            <li>Effective team leader and member with the ability to collaborate and resolve complex issues.</li>
            <li>Strong communication skills and ability to develop a lasting rapport with both co-workers and clientele.</li>
          </ul>
        <h2>Professional Experience</h2>
          <h3>Berkadia Commercial Mortgage, Client Relations Manager  2012-Present</h3>
            <ul className='proEx'>
              ...
              <li>Assist borrower in order to ensure loan compliance regarding insurance, lease, and financial reporting requirements.</li>
              <li>Review final lease approval documents and draft consent letters with conditions to be met by the borrower.</li>
          ...
          <h3>State of Utah, Judicial Assistant   2006-2012</h3>
            <ul className='proEx'>
              ...
              <li>Received and processed legal pleadings in order to ensure timeliness and conformity with judicial requirements.</li>
              <li>Prepared court orders and compiled required documents for judicial signature and entry of final judgment.</li>
        ...
        <h2>Education</h2>
          <p>Helio Training, Full Stack Web Developement, 2017-2018</p>
          <p>Salt Lake Community College, Gen Ed, 2014-2016</p>
          <p>Weber State University, Computer Science, 2010-2011</p>
